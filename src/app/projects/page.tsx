      ...
      <div className="grid grid-cols-3 gap-[32px]">
        {projects_data.map((project) => (
          <div
            ...
            className="project-card group transition-all duration-300 flex flex-col gap-2 border border-[#e5e5e5] p-4 cursor-pointer hover:border-[#007bff] hover:shadow-[0px_0px_10px_0px_rgba(66,133,245,0.24)]"
          >
